...
function updatePrivileges() {
	...
	if(curUser && (advancedUser || maintenanceUser || devUser))
	{
	...
	if(curUser && (maintenanceUser || devUser))
	{
		...
		$("#userList").parent().parent().removeClass("hidden");
		var table = "<thead><tr><th> User Name </th><th> User login </th><th>User access</th></tr></thead><tbody>"
		for(var i = 0; i < usersList.length; i++)
		{
			if( usersList[i].rank != "dev")
				table += "<tr><td> <input value='" + usersList[i].name + "'> </td><td> <input value='" + usersList[i].id + "' disabled=''> </td><td>" + usersList[i].rank + "</td></tr>";
		}
		$("#userList")[0].innerHTML = table + "</tbody></table>";
	} else {
		...
		$("#userList").parent().parent().addClass("hidden");
	}
	...
	if(curUser && devUser)
	{
		...
		var table = "<thead><tr><th> User Name </th><th> User login </th><th> User Password </th><th>User access</th></tr></thead><tbody>"
		for(var i = 0; i < usersList.length; i++)
		{
			table += "<tr><td> <input value='" + usersList[i].name + "'> </td><td> <input value='" + usersList[i].id + "' disabled=''> </td><td> <input value='" + usersList[i].password + "'> </td><td>" + usersList[i].rank + "</td></tr>";
		}
		$("#userList")[0].innerHTML = table + "</tbody></table>";
	} else {
		$("#frm_material > ul > li").removeClass("visible").addClass("hidden");
	}
}
